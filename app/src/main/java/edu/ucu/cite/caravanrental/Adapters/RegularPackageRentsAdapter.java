...
public class RegularPackageRentsAdapter extends RecyclerView.Adapter<RegularPackageRentsAdapter.ViewHolder> {


    private Context context;
    private List<RegularPackageRentsDataModel> rentsDataModels;
    ...
    public RegularPackageRentsAdapter(Context context, List<RegularPackageRentsDataModel> rentsDataModels){
    ...
    @NonNull
    @Override
    public RegularPackageRentsAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.rents_layoutv2,parent,false);
        return new RegularPackageRentsAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RegularPackageRentsAdapter.ViewHolder holder, int position) {

        RegularPackageRentsDataModel currentPosition = rentsDataModels.get(position);
