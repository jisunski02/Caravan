...
public class SMSOtpActivityOnBooking extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        verifyOTP.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //sendOTP();
                Toast.makeText(SMSOtpActivityOnBooking.this, "Verifying OTP Credentials", Toast.LENGTH_SHORT).show();
        ...
        proceed_without_verification.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(SMSOtpActivityOnBooking.this, LoginActivity.class);
    ...
    private void updateVerificationStatus(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Constants.URL_UPDATE_STATUS,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try{
                            ...
                            if(result.equals("1")){
                                Toast.makeText(SMSOtpActivityOnBooking.this, "Account successfuly verified", Toast.LENGTH_SHORT).show();

                                finish();
                            }

                            else{
                                Toast.makeText(SMSOtpActivityOnBooking.this, jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
                            }
                        }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(SMSOtpActivityOnBooking.this, error.toString(), Toast.LENGTH_SHORT).show();
            }
        }){
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                int Temp_Customer_ID = SharedPrefManager.getInstance(SMSOtpActivityOnBooking.this).getId();
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(SMSOtpActivityOnBooking.this);
        requestQueue.add(stringRequest);
    }

    public void resendOTP(){
        PhoneAuthProvider.getInstance().verifyPhoneNumber("+63"+mobileNo, 60, TimeUnit.SECONDS,
                SMSOtpActivityOnBooking.this,
                new PhoneAuthProvider.OnVerificationStateChangedCallbacks(){
                    ...
                    public void onCodeSent(@NonNull String verificationId, @NonNull PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                        ...
                        Toast.makeText(SMSOtpActivityOnBooking.this,"Verification code has been resent", Toast.LENGTH_SHORT).show();
                    }
                }
        );
    }
