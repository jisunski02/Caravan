...
public class ApproveRentsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_approve_rents, container, false);
    ...
    private void getPendingRentDataNoDriver() {
        ...
        String url = Constants.MAIN_URL+ "regularpackagerents.php?customer_id=" + Customer_IDx;
