...
public class Cmpltd_Rents extends AppCompatActivity {

    private ProgressDialog progressDialog;
    RecyclerView cmpltdrecyclerView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cmpltd__rents);

        cmpltdrecyclerView = findViewById(R.id.RentsRecyclerView);
        cmpltdrecyclerView.setLayoutManager(new LinearLayoutManager(this));
            ...
            public void onResponse(String response) {
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(Cmpltd_Rents.this, error.getMessage().toString(), Toast.LENGTH_LONG).show();
        ...
        try {
            ...
            for (int i = 0; i < result.length(); i++) {
              ...
              /*  RentsDataModel rentsDataModel = new RentsDataModel(
                ...
                if(rent_status.equals("2")){
                    rentList.add(rentsDataModel);
                } */


            }
            CompletePackageRentsAdapter rentsAdapter = new CompletePackageRentsAdapter(Cmpltd_Rents.this, rentList);
            cmpltdrecyclerView.setAdapter(rentsAdapter);
