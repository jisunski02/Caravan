    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        verifyOTP.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //sendOTP();
                Toast.makeText(SMSOtpActivity.this, "Verifying OTP Credentials", Toast.LENGTH_SHORT).show();
        ...
        proceed_without_verification.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(SMSOtpActivity.this, LoginActivity.class);
    ...
    private void updateVerificationStatus(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Constants.URL_UPDATE_STATUS,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try{
                            ...
                            if(result.equals("1")){
                                Toast.makeText(SMSOtpActivity.this, "Account successfuly verified", Toast.LENGTH_SHORT).show();
                                ...
                                Toast.makeText(SMSOtpActivity.this, jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
                            }
                        }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(SMSOtpActivity.this, error.toString(), Toast.LENGTH_SHORT).show();
            }
        }){
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                int Temp_Customer_ID = SharedPrefManager.getInstance(SMSOtpActivity.this).getId();
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(SMSOtpActivity.this);
                ...
                new PhoneAuthProvider.OnVerificationStateChangedCallbacks(){
                    ...
                    public void onVerificationFailed(@NonNull FirebaseException e) {
                        if (e instanceof FirebaseAuthInvalidCredentialsException) {
                            ...
                            Toast.makeText(getApplicationContext(), "SMS quota has been reached", Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    public void onCodeSent(@NonNull String verificationId, @NonNull PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                        ...
                        Toast.makeText(SMSOtpActivity.this,"Verification code has been resent", Toast.LENGTH_SHORT).show();
                    }
                }
        );
    }
