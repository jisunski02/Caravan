package edu.ucu.cite.caravan.Fragments;
...
public class CancelledRentsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_cancelled_rents, container, false);
    ...
    private void getPendingRentDataNoDriver() {
        ...
        String url = "https://caravan-rental-cars.000webhostapp.com/includes/regularpackagerents.php?customer_id=" + Customer_IDx;
